...
const DEFAULT_PROFILE: TeacherProfile = {
  fullName: 'Hoàng Hải Yến ( Anh Sao Khue)',
  email: 'yh2672652@gmail.com',
  phone: '0346513056',
  school: 'Hệ thống Giáo dục Thông minh Anh Sao Khue AI',
    ...
    <div className="space-y-6 animate-fadeIn pb-12 max-w-5xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="p-4 bg-slate-800/80 rounded-2xl border border-slate-700/80 text-center">
              ...
              <div className="text-[10px] text-slate-400">Anh Sao Khue AI</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl space-y-3 text-white">
        ...
        <div className="text-xs text-slate-300 space-y-1.5 leading-relaxed">
          <p>
            <strong>Đơn vị phát triển:</strong> Anh Sao Khue AI - Smart Education Ecosystem
          </p>
          <p>
            <strong>Chủ nhiệm tác giả:</strong> Hoàng Hải Yến ( Anh Sao Khue)
          </p>
          <p>
